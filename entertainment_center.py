"""This module contain functions which creates entries for Fresh Tomatoes Movie Trailer page"""
import media
...
THUPPAKKI = media.Movie("Thuppakki",
                        ...
                        ("https://images-na.ssl-images-amazon.com/images/M/MV5BMGFjZTdmMmEtO"
                         "GZmYi00NmU5LTk4MjEtYTdmN2QzMjRmMWZkXkEyXkFqcGdeQXVyNjUwNDE"
                         "zNTE@._V1_QL50_.jpg"),
                        "https://www.youtube.com/watch?v=2S0Fk2Dh9Mk")

THANI_ORUVAN = media.Movie("Thani oruvan",
                           ("Story of an Officer Mithran who wants to arrest Siddharth "
                            "Abhimanyu, an affluent scientist who uses secret illegal medical "
                            "practices for profit"),
                           ("https://images-na.ssl-images-amazon.com/images/M/MV5BNzgxMDc2Mjg3M1"
                            "5BMl5BanBnXkFtZTgwMzU4NTkxNzE@._V1_QL50_.jpg"),
...
VIKRAM_VEDHA = media.Movie("Vikram Vedha",
                           ...
                           ("https://images-na.ssl-images-amazon.com/images/M/MV5BMjI3Y2M3OTgtZm"
                            "ExNS00ZTEyLTg5NGItOWZiYjVlZWY5N2E1XkEyXkFqcGdeQXVyMzI4MzEwNQ@@._V1_QL"
                            "50_SY1000_CR0,0,749,1000_AL_.jpg"),
...
THREE_IDIOTS = media.Movie("3 Idiots",
                           ...
                           ("https://images-na.ssl-images-amazon.com/images/M/MV5BZWRlNDdkNzIt"
                            "MzhlZC00YTdmLWIwNjktYjY5NjQ1ZmQ3N2FkXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V"
                            "1_QL50_SY1000_CR0,0,747,1000_AL_.jpg"),
...
LIMITLESS = media.Movie("Limitless",
                        ("With the help of a mysterious pill that enables the user to access "
                         ...
                         "lots of dangers"),
                        ("https://images-na.ssl-images-amazon.com/images/M/MV5BYmViZGM0MGItZT"
                         "diYi00ZDU4LWIxNDYtNTc1NWQ5Njc2N2YwXkEyXkFqcGdeQXVyNDk3NzU2MTQ@._V1_Q"
                         "L50_SY1000_CR0,0,692,1000_AL_.jpg"),
                        "https://www.youtube.com/watch?v=jOLqNOfzus4")
#=======================End of movies list========================


#Create a list of movies that has to be included in the Fresh Tomatoes Movie trailer page
